...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-cosmic': 'linear-gradient(135deg, hsl(var(--cosmic-purple)), hsl(var(--cosmic-pink)), hsl(var(--cosmic-blue)))',
        'gradient-aurora': 'linear-gradient(180deg, hsl(var(--cosmic-purple) / 0.3), hsl(var(--cosmic-blue) / 0.1), transparent)',
